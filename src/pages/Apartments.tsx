...
import { ArrowLeft, MapPin, Home, Building2, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20 pb-32">
        {/* Hero Section */}
        <section className="px-6 py-10 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-2xl font-light text-slate-900 tracking-tight">Premium Apartments</h1>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-3 gap-4 mb-10">
              <div className="text-center p-4 rounded-2xl bg-slate-50">
                <p className="text-xl font-light text-slate-900">₹6,800</p>
                <p className="text-[11px] text-slate-500 mt-1">Avg. Price/sq.ft</p>
              </div>
              <div className="text-center p-4 rounded-2xl bg-slate-50">
                <p className="text-xl font-light text-slate-900">8.2%</p>
                <p className="text-[11px] text-slate-500 mt-1">YoY Appreciation</p>
              </div>
              <div className="text-center p-4 rounded-2xl bg-slate-50">
                <p className="text-xl font-light text-slate-900">2.8%</p>
                <p className="text-[11px] text-slate-500 mt-1">Rental Yield</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {neighborhoods.map((area, index) => (
                <div 
                  key={area.name}
                  className="p-5 rounded-2xl bg-white border border-slate-100 hover:border-slate-200 hover:shadow-sm transition-all"
                >
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h3 className="text-base font-medium text-slate-900">{area.name}</h3>
                      <p className="text-amber-600 text-sm font-light mt-0.5">{area.priceRange}</p>
                    </div>
