        ...
        <section className="px-6 py-10 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-2xl font-light text-slate-900 tracking-tight">Working Spaces</h1>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-3 gap-4 mb-10">
              <div className="text-center p-4 rounded-2xl bg-slate-50">
                <p className="text-xl font-light text-slate-900">15M+</p>
                <p className="text-[11px] text-slate-500 mt-1">Sq.ft Flex Space</p>
              </div>
              <div className="text-center p-4 rounded-2xl bg-slate-50">
                <p className="text-xl font-light text-slate-900">18%</p>
                <p className="text-[11px] text-slate-500 mt-1">Annual Growth</p>
              </div>
              <div className="text-center p-4 rounded-2xl bg-slate-50">
                <p className="text-xl font-light text-slate-900">91%</p>
                <p className="text-[11px] text-slate-500 mt-1">Avg. Occupancy</p>
              </div>
            </div>
          </div>
        </section>
              ...
              {coworkingHubs.map((hub) => (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h3 className="text-base font-medium text-slate-900">{hub.zone}</h3>
                      <p className="text-sky-600 text-sm font-light mt-0.5">{hub.priceRange}</p>
                    </div>
