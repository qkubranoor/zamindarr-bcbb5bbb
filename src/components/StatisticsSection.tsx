...
const StatisticsSection = () => {
  ...
  const stats = [
    ...
    },
    {
      value: 70,
      suffix: "%",
      label: "Lower Due Diligence Costs",
      isDynamic: false
    },
    {
      value: 95,
      suffix: "%",
      label: "Accuracy Across Land Records",
      isDynamic: false
    }
  ];
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-[10px] font-medium leading-snug">
                  {stat.label}
                </p>
              </div>
