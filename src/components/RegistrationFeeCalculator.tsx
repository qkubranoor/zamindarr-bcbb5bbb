    ...
    <div className="w-full max-w-sm mx-auto px-4 py-3">
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <Label htmlFor="reg-property-value" className="text-[11px] text-neutral-500 font-normal">Property Value</Label>
        ...
        <div className="space-y-1.5">
          <Label className="text-[11px] text-neutral-500 font-normal">Document Type</Label>
          ...
          {result.total === 0 ? (
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-xs text-neutral-400">Registration Fee</span>
                <span className="text-sm text-neutral-700">₹{result.registrationFee.toLocaleString('en-IN')}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-neutral-400">Processing Fee</span>
                <span className="text-sm text-neutral-700">₹{result.processingFee.toLocaleString('en-IN')}</span>
              </div>
              <div className="pt-2 border-t border-neutral-100 flex justify-between items-end">
                <span className="text-xs text-neutral-500">Total</span>
                <span className="text-xl font-medium text-neutral-900">₹{result.total.toLocaleString('en-IN')}</span>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="mt-4 pt-3 border-t border-neutral-50">
        <p className="text-[10px] text-neutral-300 leading-relaxed">
          Cap: Residential ₹25K · Commercial ₹50K · Rates subject to change
        </p>
      </div>
    </div>
  );
